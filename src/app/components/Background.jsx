...
function MyThree() {
  ...
  function init() {
    ...
    for (let i = 0; i < maxParticleCount; i++) {
      ...
      particlesData.push({
        velocity: new THREE.Vector3(-0.5 + Math.random() * 0.5, -0.5 + Math.random() * 0.5, -0.5 + Math.random() * 0.5),
        numConnections: 0,
      });
    }
  ...
  return <div ref={refContainer} className={styles.anim}></div>;
}
