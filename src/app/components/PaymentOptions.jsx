            ...
            <div className={styles.inputsection}>
              ...
              {ticketNames.map((ticketName, index) => (
                <div key={index}>
                  ...
                  <input name={`ticket${index + 1}`} type="text" placeholder="Name" />
                </div>
              ))}
            </div>
          </div>
          ...
          <div className={styles.prisContainer}>
            ...
            <div className={styles.prisElement}>
              <div>
                ...
                <p>
                  <span>{props.tickets}x</span> Foo fest
                </p>
              ...
              <button className={styles.creditcard_button} onClick={payticket} type="button">
                insert Card information
              </button>
              {/* <button >Place order</button>    */}
              <button className={`${styles.place_order} ${showButton ? styles.show : styles.hide}`} onClick={() => props.setCurrentStep(3)}>
                Place order
              </button>
            </div>
          </div>
